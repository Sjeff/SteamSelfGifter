...
class SettingsBase(BaseModel):
    ...
    wishlist_priority: bool = Field(
        default=True,
        description="Process wishlist giveaways before general autojoin, bypassing price/game-quality filters",
    )
...
class SettingsUpdate(BaseModel):
    ...
    wishlist_priority: bool | None = Field(
        default=None,
        description="Process wishlist giveaways before general autojoin, bypassing price/game-quality filters",
    )
