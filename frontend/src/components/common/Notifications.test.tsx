...
describe("Notifications", () => {
  ...
  it("should render a success notification", () => {
    useUIStore.setState({
      notifications: [{ id: "1", type: "success", message: "Success message" }],
    });
  ...
  it("should render an info notification", () => {
    useUIStore.setState({
      notifications: [{ id: "1", type: "info", message: "Info message" }],
    });
  ...
  it("should render a warning notification", () => {
    useUIStore.setState({
      notifications: [{ id: "1", type: "warning", message: "Warning message" }],
    });
