...
describe("Toggle", () => {
  it("should render with label", () => {
    render(
      <Toggle label="Enable Feature" checked={false} onChange={() => {}} />,
    );
  ...
  it("should call onChange when label is clicked", () => {
    ...
    fireEvent.click(
      screen.getByRole("switch").parentElement!.querySelector("label")!,
    );
  ...
  describe("disabled state", () => {
    it("should be disabled when disabled prop is true", () => {
      render(
        <Toggle label="Feature" checked={false} onChange={() => {}} disabled />,
      );
